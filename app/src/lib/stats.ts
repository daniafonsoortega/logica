...
export interface GameResult {
  ...
  primeiraVez: boolean
  dataISO: string
  nivel?: string      // 'facil' | 'medio' | 'dificil' | 'expert'
  tipoPuzzle?: string // 'grade' | 'detetive' | 'sequencia' | 'mentiu' | 'codigo' | 'cifra'
}
...
export function recordResult(result: GameResult): GlobalStats {
