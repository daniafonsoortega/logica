...
export const metadata: Metadata = {
  title: 'Sobre — MalhaMente',
  description: 'Conheça o MalhaMente, a plataforma de treino de raciocínio lógico.',
}
...
export default function SobrePage() {
  return (
    <div className="max-w-2xl mx-auto space-y-8">
      <div>
        <h1 className="text-3xl font-black text-gray-900 mb-2">Sobre o MalhaMente</h1>
        <p className="text-gray-500 text-sm">Plataforma de treino de raciocínio lógico</p>
      </div>
      <div className="prose prose-gray max-w-none space-y-4 text-gray-700 leading-relaxed">
        <p>
          O <strong>MalhaMente</strong> é uma plataforma gratuita criada para ajudar pessoas a desenvolverem
        ...
        <p>
          O MalhaMente é e continuará a ser gratuito. Para manter o servidor no ar, utilizamos
